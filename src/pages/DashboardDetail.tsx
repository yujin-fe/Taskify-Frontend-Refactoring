...
import { getColumnList } from '@/lib/apis/columns';
...
export default function DashboardDetail() {
  ...
  const { data: columnDataList, isLoading: isColumnLoading } = useQuery<ColumnsResponse>({
    fetchFn: () => {
      if (!dashboardId) {
        throw new Error('dashboardId is missing');
      }
      return getColumnList(dashboardId);
    },
  });
