...
export default function HomeTopArea() {
  return (
    <section className='flex flex-col items-center gap-12 px-[40px]'>
      ...
      <Title
        className='flex flex-col items-center gap-1.5 text-[40px] leading-[48px] tracking-[-2px] text-gray-0 md:flex-row md:gap-6 md:text-[56px] md:leading-[100px] lg:gap-7 lg:text-[76px]'
        weight={'bold'}>
        <span>새로운 일정 관리</span>
